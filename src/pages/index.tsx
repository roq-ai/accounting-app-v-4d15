...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Accounting APP v3`}</title>

        <meta
          name="description"
          content="Experience the power of comprehensive financial management with Accounting APP v3. Offering user-specific roles, personalized dashboards, multi-tenant support, robust accounting functions, efficient invoicing and billing, and advanced expense management. Plus, enjoy customizable financial reporting, tax compliance, bank integration, and multilingual support. Securely store documents, track user activities, and stay updated with notifications and alerts. Welcome to Accounting APP v3, your partner in financial success."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of comprehensive financial management with Accounting APP v3. Offering user-specific roles, personalized dashboards, multi-tenant support, robust accounting functions, efficient invoicing and billing, and advanced expense management. Plus, enjoy customizable financial reporting, tax compliance, bank integration, and multilingual support. Securely store documents, track user activities, and stay updated with notifications and alerts. Welcome to Accounting APP v3, your partner in financial success.`}
            </Text>
            <Box

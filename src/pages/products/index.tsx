...
export function ProductListPage(props: ProductListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getProducts({
        ...
        order: params.order,
        searchTermKeys: ['product_name.contains', 'uom.contains', 'unit_price.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'hsn_code', header: 'hsn_code', accessorKey: 'hsn_code' },
    { id: 'uom', header: 'Uom', accessorKey: 'uom' },
    { id: 'unit_price', header: 'Unit Price', accessorKey: 'unit_price' },
    !hideActions
      ? {
          id: 'actions',
          header: '',
